...
//        if ($process->approval_type == ApprovalType::ApprovalQuotation->value)
        ...
        $process->financial_orders = FinancialOrder::where('order_id', $process->order_id)->get();
    ...
    public function form(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $typeText = match ($approvalOrder->approval_type) {
                ...
                ApprovalType::ApprovalRepaired->value => '付款审核',
                ApprovalType::ApprovalPayment->value => '已修复资料审核',
            };
