...
class ApprovalResultNotifyJob implements ShouldQueue
{
     ...
     */
    public function __construct(int $user_id, $extras = [], $title = '')
    {
...
//            }
        ...
        $client->push()
            ...
            ->androidNotification('审批结果', $android)
            ->iosNotification('审批结果', $ios)
            ->setOptions(5,)
            ->send();
    }
}
